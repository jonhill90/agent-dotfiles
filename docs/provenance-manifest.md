...
| `safe-deletion` skill | self | Author (eval-justified 2026-07-18) | Copilot E11 failed with the canonical gate provably loaded; skill binds it — PASS ×2 on Copilot, no Codex/CC/Pi regression ([clearance](../tests/evals/results/2026-07-18-p2m3-blockers-cleared.md)) |
| `failing-test-first` skill | self | Author (eval-justified 2026-07-18) | Copilot E06 failed ×2 interactive on the pinned model; skill flips it to red-green — PASS ×2 ([clearance](../tests/evals/results/2026-07-18-p2m3-blockers-cleared.md)) |
