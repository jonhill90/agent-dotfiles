...
| Obsidian access CLI | third-party obsidian-cli (Yakitrak) vs official Obsidian CLI | Adopt third-party, pinned (V6 resolved 2026-07-12) | Official CLI remote-controls the running app — fails acceptance check 5 (GUI-free) by design; `ob` headless client is Sync/Publish only. Revisit if official gains GUI-free note CRUD ([obsidian-cli-v6](research/obsidian-cli-v6.md)) |
